                              ...
                              <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 main">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 v1">
                                     <p><b id="b1">Work :- </b><?php echo  $work ?></p>
                                     <p><b id="b1">Mobile No :- </b><?php echo $mobile1?></p>
                                     <p><b id="b1">Address :- </b><?php echo  $address?></p>

                                    </div>
                                    
                                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 v1">
                                    <p><b id="b1">Mobile No :- </b><?php echo $mobile2 ?></p>
                                     <p><b id="b1">Blood Group :- </b><?php echo $bloodg ?></p>
