             ...
             <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 user1">
                     ...
                     <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 user2">
                            ...
                            <form action="../savepages/usersave.php" method="POST" role="form">
                                   <legend style="text-align: center;">Create ID-User-Type</legend>
                                   <br>

                                   <?php
                                          require("../dbcon.php");
                                          $sql="select max(id) from tblidusertype";
                                   ...
                                   <div class="form-group">
                                          <input type="text" class="form-control" id="txtidusertype" name="txtidusertype" placeholder="ID-User-Type" autocomplete="off">
                                       
                                   </div>
                            
                                   <button type="submit" name="btnsaveidusertype" id="btnsaveidusertype" class="btn btn-primary btn-block">Submit</button>
                            </form>
