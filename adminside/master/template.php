       ...
       <head>
              ...
              <script>
                     $(function(){
                            ...
                            $(".t2").click(function(){
                                   open('../template/template2.php','_self');
                            });

                            $(".t3").click(function(){
                                   open('../template/template4.php','_self');
                            });

                            $(".t4").click(function(){
                                   open('../template/template1.php','_self');
                            });

                            $(".t5").click(function(){
                                   open('../template/template5.php','_self');
                            });

                            $(".t6").click(function(){
                                   open('../template/template6.php','_self');
                            });
       ...
       <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 createuser1" >
          ...
          <button type="button" id="btnexit" class="btn btn-danger">Back</button>
              ...
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 createuser2">
                     ...
                     <div id="t1" class="t1">
                            <img src="../image/template3.png" alt="" >
                            <p>Template 1</p>
                     </div>
                     ...
                     <div id="t1" class="t6">
                            <img src="../image/template6.png" alt="">
                            <p>Template 3</p>
                     </div>


                     <div id="t1" class="t3" >
                            <img src="../image/template4.png" alt="">
                            <p>Template 4</p>
                     </div>
                     ...
                     <div id="t1" class="t5">
                            <img src="../image/template5.png" alt="" >
                            <p>Template 5</p>
                     </div>
                     <div id="t1" class="t2">
                            <img src="../image/template2.png" alt="">
                            <p>Template 6</p>
                     </div>
